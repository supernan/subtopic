...
ict::CSubTopic::CSubTopic(std::string &plsa_conf_path)
{
...
void ict::CSubTopic::_get_plsa_topics()
{
...
void ict::CSubTopic::_words_occurrence(std::vector<std::string> &key_words, std::string &text,
...
void ict::CSubTopic::_words_relations(std::vector<std::vector<int> > &matrix, int thresh,
...
bool ict::CSubTopic::_generate_topic_words(int thresh, int min_count)
{
...
bool ict::CSubTopic::_generate_docs(double match_rate)
{
...
bool ict::CSubTopic::generate_sub_topics(std::vector<WeiboTopic_ICT::Weibo> &doc_list,
